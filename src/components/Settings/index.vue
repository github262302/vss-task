<template>
    <el-form ref="settingsForm" :model="form" :rules="rule">
        ...
        <el-form-item label="背景图片" v-if="form.bgCustom" prop="bgPath">
            <el-input readonly class="folderInput" style="padding-right: 0;" v-model="form.bgPath" placeholder="请输入背景图片路径">
                <template #append>
                    <div>
        ...
        <el-form-item label="动画路径" v-if="form.animationCustom" prop="animationCustom">
